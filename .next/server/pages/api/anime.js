...
// EXTERNAL MODULE: ./node_modules/gogoanime-api/lib/anime_parser.js + 55 modules
var anime_parser = __webpack_require__(8486);
...
;// CONCATENATED MODULE: ./src/generated/aniList.ts
...
const AnimeBannerFragmentDoc = (external_graphql_tag_default())`
...
`;
const AnimeInfoFragmentDoc = (external_graphql_tag_default())`
...
`;
const GetAnimeBannerDocument = (external_graphql_tag_default())`
...
`;
const GetAnimeInfoDocument = (external_graphql_tag_default())`
...
`;
const GetAnimeByIdsDocument = (external_graphql_tag_default())`
  ...
  ${AnimeInfoFragmentDoc}
`;
const GetAnimeTitleDocument = (external_graphql_tag_default())`
...
`;
const GetPopularBannerDocument = (external_graphql_tag_default())`
  ...
  ${AnimeBannerFragmentDoc}
`;
const SearchAnimeDocument = (external_graphql_tag_default())`
  ...
  ${AnimeInfoFragmentDoc}
`;
const SearchGenreDocument = (external_graphql_tag_default())`
  ...
  ${AnimeInfoFragmentDoc}
`;
const GetListDocument = (external_graphql_tag_default())`
  ...
  ${AnimeInfoFragmentDoc}
`;
const IndexPageDocument = (external_graphql_tag_default())`
  ...
  ${AnimeInfoFragmentDoc}
`;
const AnimePageDocument = (external_graphql_tag_default())`
  ...
  ${AnimeBannerFragmentDoc}
`;
const WatchPageDocument = (external_graphql_tag_default())`
...
const GetEpisodeKitsuDocument = (external_graphql_tag_default())`
  ...
  ${EpisodesListFragmentDoc}
`;
const kitsu_defaultWrapper = (action, _operationName, _operationType)=>action()
;
function kitsu_getSdk(client, withWrapper = kitsu_defaultWrapper) {
    return {
...
const aniListClient = new external_graphql_request_namespaceObject.GraphQLClient(aniListEndpoint, {
    headers: {}
});
const kitsuClient = new external_graphql_request_namespaceObject.GraphQLClient(kitsuEndpoint, {
    headers: {}
});
const { indexPage , animePage , getList , searchAnime , getAnimeInfo , getPopularBanner , getAnimeBanner , getAnimeTitle , searchGenre , watchPage , getAnimeByIds ,  } = getSdk(aniListClient);
...
const kitsuMiddleware = async (action)=>{
    ...
    try {
        ...
        if (!(err instanceof external_graphql_request_namespaceObject.ClientError)) throw err;
        result = err.response.data;
    }
    return result;
};
const { getAnimesKitsu , getEpisodeKitsu  } = kitsu_getSdk(kitsuClient, kitsuMiddleware);
/**
...
;// CONCATENATED MODULE: ./src/lib/gogoanime.ts
...
async function getAnimeSlug(title, episode) {
    ...
    const gogoEpisodes = (await (0,anime_parser/* scrapeAnimeDetails */.cJ)({
    ...
    const subAnime = (0,anime_parser/* scrapeMP4 */.ey)({
        id: `${episodeSlug}-episode-${episode}`
    });
    const dubAnime = (0,anime_parser/* scrapeMP4 */.ey)({
...
async function getAnime(id, episode) {
    let { english , romaji  } = (await getAnimeTitle({
        id
    })).Media.title;
...
;// CONCATENATED MODULE: ./src/pages/api/anime.ts
...
var __webpack_exports__ = __webpack_require__.X(0, [486], () => (__webpack_exec__(3796)));
